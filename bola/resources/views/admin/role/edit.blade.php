...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" action="{:U('Role/save')}" id="postform" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="first-name" name="name" value="{{$role->name}}" required="required" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          {{--<div class="form-group">--}}
            ...
            {{--</label>--}}
            {{--<div class="col-md-6 col-sm-6 col-xs-12">--}}
              {{--<input type="text" id="last-name" name="description" value="{{$role->description}}" required="required" class="form-control col-md-7 col-xs-12">--}}
            {{--</div>--}}
          {{--</div>--}}
