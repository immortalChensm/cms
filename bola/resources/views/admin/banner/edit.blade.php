...
@section("content")
    <div class="right_col" role="main">
                ...
                <div class="col-md-9 docs-buttons">
                    ...
                    <div class="btn-group">
                        ...
                        <label class="btn btn-primary btn-upload" for="inputImage" title="Upload image file">
                            ...
                            <span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="上传图片">
        ...
        <form method="post" action="{:U('Banner/save')}" id="postform" data-parsley-validate class="form-horizontal form-label-left">
            <input type="hidden" name="_token" value="{{csrf_token()}}">

            <input type="hidden" name="image" value="" id="imgdata">
            <input type="hidden" name="imgid" value="{{$banner->id}}" >
            <input type="hidden" name="imgurl" value="{{$banner->image}}" >
            {{ method_field('PUT') }}
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">标题 <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" name="title" value="{{$banner->title}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="last-name" name="url" value="{{$banner->url}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="last-name" name="sort" value="{{$banner->sort}}" required="required" class="form-control col-md-7 col-xs-12" style="width:100px !important;">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div id="gender" class="btn-group" data-toggle="buttons">
                        ...
                        <input type="radio" name="status" @if($banner->status==1) checked="checked" @endif value="1"> &nbsp; 开启 &nbsp;

                        <input type="radio" name="status"  @if($banner->status==0) checked="checked" @endif value="0"> 禁用
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <div class="btn-group btn-group-crop"  id="savePrevImg" >
                        <button type="button" onclick="save('savePrevImg')" class="btn btn-primary" data-method="getCroppedCanvas">
    ...
    <script type="text/javascript">
        function save(savePrevImg){
            if($("#"+savePrevImg).attr("status")!="finish"){
                if($("#imgid").val()<1){
                    layer.msg("插件未成功上传图片请重试");
                    return false;
                }
            ...
            $.ajax({
                type: 'POST',
                url: "{{url('admin/banner')}}/"+{{$banner->id}},
                processData:false,
                contentType:false,
                dataType: 'json',
                data: form,
