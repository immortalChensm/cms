        ...
        <div class="container cropper">
            ...
            <div class="row">
                <div class="col-md-9 docs-buttons">
                    ...
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" data-method="reset" title="Reset" style="display: none">
                          <span class="docs-tooltip" data-toggle="tooltip" title="" data-original-title="">
                    ...
                    <div class="btn-group btn-group-crop" style="display:none;" style="display: none">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                    ...
                    <div class="btn-group btn-group-crop"  id="savePrevImg" >
                        <button type="button" onclick="save('savePrevImg')" class="btn btn-success" data-method="getCroppedCanvas">
