    ...
    <div class="row" style="width:100%;">
      <div class="col-md-6 col-sm-6 col-xs-12" style="width:100%;">
        <div class="x_panel" style="width:100%;">
          <div class="x_title">
            <h2>职位管理/职位列表<small><a href="{{route('position.create')}}" class="btn btn-info" >添加</a></small></h2>
          ...
          <div class="x_content">
            ...
            <table class="table" width="100%">
              ...
              <tr>
                ...
                <td><a href="{{route('position.edit',$position->id)}}" class="btn btn-default">编辑</a><a class="delete" href="#" data-id="{{$position->id}}">移除</a></td>
              </tr>
               @endforeach
              </tbody>
            </table>
