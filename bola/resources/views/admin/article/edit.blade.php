...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        <br />
        <form method="post" action="{:U('Article/save')}" id="postform" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="first-name" name="title" required="required" value="{{$data->title}}" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="content" name="content" class="txt" value="{{$data->content}}" style="width:800px;">{{$data->content}}</textarea>
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12">推荐到首页</label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div id="gender" class="btn-group" data-toggle="buttons">
                    <input type="radio" name="is_recommend"  @if ($data->is_recommend == 1)checked @endif  value="1"> &nbsp; 开启 &nbsp;
                  <input type="radio" name="is_recommend"  @if ($data->is_recommend == 0)checked @endif  value="0"> 禁用
              </div>
            </div>
          </div>
