  ...
  <div class="right_col" role="main">
    <!-- top tiles -->
      <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
              <div class="x_title">
                  {{--<h2>资讯管理/列表<small><a href="{{route('article.create')}}" class="btn btn-info" >添加</a></small></h2>--}}
                  <h2>
                      <ul class="search-header">
                          ...
                          <li><small ><a  class="btn btn-info search" data-url="/admin/article">搜索</a></small></li>
                          <li><small ><a href="{{route('article.create')}}" class="btn btn-info" >添加</a></small></li>
                      </ul>
