  ...
  <div class="right_col" role="main">
    ...
    <form method="post" action="{:U('brand/insert')}" id="postform" data-parsley-validate class="form-horizontal form-label-left">
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <select name="pid">
            ...
            <option value="{{$val->id}}"  @if ($val->id == $data->pid)checked @endif >{{$val->name}}</option>
            @endforeach
          </select>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="last-name" name="url" value="{{$data->url}}" required="required" class="form-control col-md-7 col-xs-12">
        </div>
      </div>
      <div class="form-group">
