        ...
        <form method="post" action="{:U('News/save')}" id="postform" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" id="first-name" name="title" required="required" value="{{$news->title}}" class="form-control col-md-7 col-xs-12">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="content" name="content" class="txt" value="{{$news->content}}" style="width:800px;">{{$news->content}}</textarea>
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <div id="gender" class="btn-group" data-toggle="buttons">
                    <input type="radio" name="status"  @if ($news->status == 1)checked @endif  value="1"> &nbsp; 开启 &nbsp;
                  <input type="radio" name="status"  @if ($news->status == 0)checked @endif  value="0"> 禁用
              </div>
            </div>
          </div>
