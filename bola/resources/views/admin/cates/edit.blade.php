...
@section("content")
    <div class="right_col" role="main">
        ...
        <form method="post" action="{:U('cates/save')}" id="postform" data-parsley-validate class="form-horizontal form-label-left">
            <input type="hidden" name="_token" value="{{csrf_token()}}">

            <input type="hidden" name="image" value="" id="imgdata">
            <input type="hidden" name="id" value="{{$cates->id}}" >
            <input type="hidden" name="imgurl" value="{{$cates->image}}" >
            <input type="hidden" name="_method" value="PUT">
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">标题 <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="first-name" name="title" value="{{$cates->title}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="last-name" name="url" value="{{$cates->url}}" required="required" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div id="gender" class="btn-group" data-toggle="buttons">
                        ...
                        <input type="radio" name="status" @if($cates->status==1) checked="checked" @endif value="1"> &nbsp; 开启 &nbsp;

                        <input type="radio" name="status"  @if($cates->status==0) checked="checked" @endif value="0"> 禁用
