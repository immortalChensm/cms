<nav class="navbar navbar-default navbar-fixed-top mynav" role="navigation" style="background-color:#dc2c2c">
    <div class="container-fluid w1200">
        <div class="navbar-header">
            <button id="iNav" type="button" class="navbar-toggle" data-attr="1">
                <span class="sr-only">切换导航</span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
                <span class="icon-bar"></span>
            </button>
            <a class="navbar-brand" href="index.html"><img src="{{ URL::asset('home/images/logo-white.png') }}" alt=""></a>
        </div>
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" style="background-color:#dc2c2c">
            ...
            <img class="nav_bot_img1" src="{{ URL::asset('home/images/nav_bot_img1.png')}}" alt="">
        </div>
    </div>
</nav>