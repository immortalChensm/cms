...
<div class="container_top">
    <div class="index-row w1200" style="margin-top: 120px;padding: 0 10px;">
       <div id="content">
		   ...
		   <div class="col-md-4 col-xs-12 casebox"><i><img src="http://bola.mppstore.com/{{$data->image}}" alt="{{$data->title}}"></i><p>{{$data->title}}</p></div>
			   @endforeach
       </div>
...
<script>
    $(function () {
        var data = [
			{id: '001', src: 'images/case/success_01.png', text: '新零售整体解决方案'},
			{id: '001', src: 'images/case/success_02.png', text: '汽车销售及交车系统'},
			{id: '001', src: 'images/case/success_03.png', text: '电子商务渠道管理平台'},
