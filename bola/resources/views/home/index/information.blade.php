...
<div class="">
    <div class="head">
        ...
        <div class="head-ud container">
            <ul>
                ...
                <li class="fs18 xuanzhong"><a href="17information.html">最新资讯</a></li>
    ...
    <div class="context">
        <div class="yltyy container">
            您现在的位置：<a href="01home.html"> 首页</a> > 最新资讯
        </div>
        <div class="yylist container">
            <div class="searchk">
                <input type="text" placeholder="资讯"/>
                <button type="button"></button>
            </div>
            <div class="teachlist">
                <div class="oneteachlist">
                    <span class=""></span>
                    <span class="listtitle">市疾控中心：未采购相关批次问题疫苗</span>
                    <span class="datetime">2018-08-03</span>
                </div>
                <div class="oneteachlist">
                    <span class=""></span>
                    <span class="listtitle">最全最实用的协和APP攻略，35大功能了解一下！</span>
                    <span class="datetime">2018-08-03</span>
                </div>
                <div class="oneteachlist">
                    <span class=""></span>
                    <span class="listtitle">北京协和医院举办第四批“组团式”援藏医疗队欢送会</span>
                    <span class="datetime">2018-08-03</span>
                </div>
                <div class="oneteachlist">
                    <span class=""></span>
                    <span class="listtitle">赵家良教授当选国际眼科科学院副主席</span>
                    <span class="datetime">2018-08-03</span>
                </div>
                <div class="oneteachlist">
                    <span class=""></span>
                    <span class="listtitle">协和登顶！亚洲华人地区顶级医院100强名单出炉</span>
                    <span class="datetime">2018-08-03</span>
                </div>
                <div class="oneteachlist">
                    <span class=""></span>
